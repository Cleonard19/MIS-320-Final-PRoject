...
namespace Team4.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IngredientID,Name,QtyAvail,UnitPrice")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IngredientID,Name,QtyAvail,UnitPrice")] Ingredient ingredient)
        {
            if (ModelState.IsValid)
            {
